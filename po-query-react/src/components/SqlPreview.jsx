    ...
    <div>
      <div className="sql-preview">
        <div className="sql-preview-header">
          <span style={{ width: 8, height: 8, borderRadius: 'var(--r-pill)', background: 'var(--border-accent)', display: 'inline-block' }} />
          <span style={{ width: 8, height: 8, borderRadius: 'var(--r-pill)', background: 'var(--border-accent)', display: 'inline-block', marginLeft: 4 }} />
          <span style={{ width: 8, height: 8, borderRadius: 'var(--r-pill)', background: 'var(--border-accent)', display: 'inline-block', marginLeft: 4 }} />
